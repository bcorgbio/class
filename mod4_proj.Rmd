...
As you've probably noticed in reading markdowns so far, where any code and names of code are written in the text (i.e., not in a chunk), the convention is to specify code-bearing text as such by wrapping it in 

<code>`</code>, e.g., <code>`ggplot`</code>. 
