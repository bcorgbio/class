...
You are free to pursue any methods introduced in the course. This may include, but need not be limited to, using a temperature, force, or acceleration prototype or purely data-driven analysis. All projects should include **visualization** and **modeling** approaches that mirror those used in the course so far. 
