...
<div class = "green">
<div class="row">
  <div class="col-sm-2"><b>Rubric Benchmark</b></br>`r fa("check-square", fill = "black",height="50")`</a> <!-- regular style --></div>
  <div class="col-sm-9">
...
<div class = "green">
<div class="row">
  <div class="col-sm-2"><b>Feedback</b></br>`r fa("sticky-note", fill = "black",height="50")`</a> <!-- regular style --></div>
  <div class="col-sm-9">
...
<div class = "green">
<div class="row">
  <div class="col-sm-2"><b>Grade</b></br>`r fa("check-square", fill = "black",height="50")`</a> <!-- regular style --></div>
  <div class="col-sm-9">
