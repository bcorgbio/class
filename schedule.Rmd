...
In Module 3, we'll cover the basics of visualizing and modeling data and hypothesis testing. We've used some simple visualization techniques in `ggplot` alsready and we'll leverage this introduction to dig deeper into how data can be plotted to explore and ask informed questions about it.
...
All form [R for Data Science](https://r4ds.had.co.nz/wrangle-intro.html) (R4DS):
  ...
  + [Chapter 3: Transformations](https://r4ds.had.co.nz/data-visualisation.html)
