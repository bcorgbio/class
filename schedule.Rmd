...
<!-- ## Module 3: Data Wrangling Introduction to Tools of the Trade in Data Analysis -->
...
<!-- All from the [Wrangle Section](https://r4ds.had.co.nz) of [R for Data Science](https://r4ds.had.co.nz/wrangle-intro.html) (R4DS) -->
...
<!-- When reading through R4DS, make sure to have R and R Studio up and running so that you can copy and paste code from HOPR into an R file and run the specified commands and complete the books exercises. This will help tremendously in getting the hang of things.  -->
