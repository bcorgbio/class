...
In this phase, we'll learn the basics of data science and analysis by working through four learning modules devoted to core topics in the field. This will most likely be the most challenging part of the course because many, if not most of you have not approached quantitative analysis in way similar to an organismal biologist. Rest assured, your experience will be curated, sticking to the bare bones of data science. This introductory phase will set the groundwork for Phase II, independent data analysis.
...
**Wednesday, 9/2**: Establish GitHub account and add your handle to [this form](https://forms.gle/5Fx1B7P5hJEVUQUH7) 

**Friday, 9/4**: Create a private GitHub repo and add Prof. K as a collaborator.

**Wednesday, 9/9**: [WCR 1](WCRs/WCR_1.html)

**Sunday, 9/13**: Commit [Module 1 Project](mod1_proj.html) report
...
And [this very helpful video](https://www.youtube.com/embed/QLFc9gw_Hfs?si=aM4hlKYhCyJcoX0V).


Be sure you're familiar with the [prerequsites](https://happygitwithr.com/rstudio-git-github.html#prerequisites) outlined in Chapter 12. **We'll cover git and github in class on Wednesday, September 2nd.** Just introduce yourself to the concepts.
...
### Do
  ...
  + Clone a github team repository to a local directory (done in class with Prof. K's help on **Wednesday, Sept 2nd**)
...
**Sunday, 9/20**: commit [Module 2 Project](mod2_proj.html) report
...
**Sunday, 9/27**: Commit Module 3 Project report
...
**Sunday, 10/4**: Commit Module 4 Project Report
...
### Do 
  ...
  + Post one and respond to one question in [discussion board](https://github.com/orgs/bcorgbio/teams/biol-3140) [10 points]
  + Complete and commit a report for Module 4 Project 
...
In Phase II, we'll use our new-found instrument- and code-development skills to address key questions in organismal biology. These will be self-guided explorations meant to challenge you to put these skills to good use in answering how and why vertebrate shape has evolved, why phylogeny matters in comparative analysis, and how a landscape and changing climate impacts the distribution and phenology of species.  Within this phase we'll break up into our teams to focus on 4 modules, all very data driven.

## Module 5: Puffer Shape

This module puts our newly formed data analysis and markdown skills to use in answering how body shape evolved in the tetraodontiform fishes (i.e., pufferfish and allies). Specifically, we'll test whether body shape has evolved differently between species inhabiting different habitats.

### Important Dates:

**Thursday, 10/15**: Upload data  
**Sunday, 11/1**: Commit Module 5 Project Report
...
### Do
  ...
  + Upload team data files to [this directory](https://drive.google.com/drive/folders/1j7sod1NB1jmEiPiduYvOOIlukkMikfL5?usp=drive_link) by **Thursday, October 15th**
...
This module explores how landscape characteristics shape the distriubtion of white tail deer in the great state of New Hampshire. For this, we'll leverage a combination of geospatial and machine learning analysis.

### Important Dates

**Sunday, 11/15**: Commit Module 6 Project Report
...
**11/15**: Commit Module 6 Project Report
...
**Sunday, 12/6**: Commit Module 7 Project report
...
**Friday, 12/18**: Commit Final Project report
