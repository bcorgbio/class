...
In your future project reports for Phase I and II of the class, you'll always want to include sections for an introduction, methods, results, conclusions, and bibliography. So add those sections to your .Rmd. with a high-level header `#`.  We'll add nested subsections and test later.  
...
You can insert code chunks with by selecting the "insert" icon at the top of the 
...
The content inside the curly brackets (`{}`) controls the behavior of code chunk. In this case, we'll telling R markdown that the code inside the chunk is to be interpreted with R. This is a handy place to control the output of the code chunk.  
