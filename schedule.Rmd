...
## Module 5: Rolly Polly Fish Heads: Head Shape Evolution in the Actinopterygii

This module puts our newly formed data analysis and markdown skills to use in answering how head shape has evolved in the Actinopterygii (i.e., the ray-finned fishes). Specifically, we'll test head shape has evolved differently between major groups within the lineage.
