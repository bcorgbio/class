...
PC_extremes <- PCA %>% 
  ...
  select(Comp1,Comp2,sp,file_name) %>% 
...
km <-  kmeans(x = PCA %>% select(Comp1,Comp2,Comp3,Comp4), centers = 2,nstart=50)
...
Project reports should be uploaded by 11:59 PM on Sunday, October 27th.
