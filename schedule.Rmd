...
**Wednesday, 8/27**: Establish GitHub account and add your handle to [this form](https://forms.gle/5Fx1B7P5hJEVUQUH7) 

**Friday, 8/29**: Create a private GitHub repo and add Prof. K as a collaborator.

**Wednesday, 9/3**: [WCR 1](WCRs/WCR_1.html)

**Sunday, 9/7**: Commit [Module 1 Project](mod1_proj.html) report
...
Be sure you're familiar with the [prerequsites](https://happygitwithr.com/rstudio-git-github.html#prerequisites) outlined in Chapter 12. **We'll cover git and github in class on Wednesday, August 27th.** Just introduce yourself to the concepts.
...
### Do
  ...
  + Clone a github team repository to a local directory (done in class with Prof. K's help on **Wednesday, Aug 27th**)
...
**Sunday, 9/14**: commit [Module 2 Project](mod2_proj.html) report
...
**Sunday, 9/21**: Commit Module 3 Project report
...
**Sunday, 9/28**: Commit Module 4 Project Report
...
**Wednesday, 10/8**: Upload data  
**Sunday, 10/19**: Commit Module 5 Project Report
...
### Do
  ...
  + Upload team data files to [this directory](https://drive.google.com/drive/folders/1j7sod1NB1jmEiPiduYvOOIlukkMikfL5?usp=drive_link) by **Wednesday, October 8th**
...
**Sunday, 11/9**: Commit Module 6 Project Report
...
**11/9**: Commit Module 6 Project Report
...
**Sunday, 11/23**: Commit Module 7 Project report
...
**Monday, 12/8**: Commit Final Project report
