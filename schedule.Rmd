...
|--------|-------- |--------|-------- |--------|--------|--------|--------    
**Assignment due** | | | Post question to discussion board | Answer a question on discussion board | | | Push/commit Module 5 Project Report

 || Monday <br> 10/10 |  Tuesday <br>10/11   | 
|--------|-------- |--------|-------- |--------|--------|--------|--------    
**Assignment due** | |Push/commit Module 5 Project Report | | | | | 
...
## Do
  ...
  + Post one and respond to one question in [discussion board](https://github.com/orgs/bcorgbio/teams/biol-3140)
  + Upload team data files to [this directory](https://drive.google.com/drive/folders/11VBPXKHWvlBSZ9z2asQ8EG4NYsGoOk0U?usp=sharing) by Tuesday, October 11th
...
*Note: There will be no class on Friday 10/14 and Tuesday 10/18 is a Monday schedule.
