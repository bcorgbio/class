...
- Take this survey: https://forms.gle/phG5vF6PWw9raxmV9
...
This team must establish two things:
  ...
  2. A team discussion on GitHub that includes me (@ckenaley) on the team (see [Discussion Board](https://github.com/orgs/bcorgbio/discussions)). 
