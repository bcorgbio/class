...
Assembly for this temperature logger is almost entirely captured in [this tutorial](captureshttp://arduinolearning.com/projects/temperature-logger.php). To this prototype, we must add battery power. That's easy enough: merely connect the battery power cable in the battery barrel connector on the Arduino (see pic below). 
