...
|--------|-------- |--------|-------- |--------|--------|--------|--------    
**Assignment due** | | | Post question to discussion board | Answer a question on discussion board  <br> <br> [WCR 1](WCRs/WCR_1.html)| | | commit Module 1 project report
 |||||||
<br>
...
All assignments are due at 11:59 on the specified date. 
  ...
  |--------|-------- |--------|-------- |--------|--------|--------|--------
  **Assignment due** | | | Post question to discussion board | Answer a question on discussion board  <br> <br> [WCR 2](WCRs/WCR_2.html)| | | commit Module 2 Project Report
  ||||||||
